<template>
  <div class="flex items-center h-full w-full p-10">
    <div id="site-one-txt" class="w-1/2">
      <h1 class="text-eva lg:text-3vw text-4vh mix-blend-difference">Мой первый сайт.</h1>
      <p class="text-noto lg:text-1vw text-1vh">Все мы с чего-то начинали. Я, естественно, не исключение. В основном,
...
особо интересен, поэтому тут его нет.</p>
    </div>
  </div>
</template>
